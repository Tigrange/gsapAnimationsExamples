...
tl.fromTo('.hero-img',{scale:1.3,borderRadius:"0"},{scale: 1,borderRadius: "2rem",delay:0.35,duration: 2.5,ease:'elastic.out(1.5,1)'});
...
gsap.fromTo('.letter',{y:30},{y:0,delay:2,stagger : 0.05,ease:"back.out(3)"});
